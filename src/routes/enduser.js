// zippee-backend - File src/routes/enduser.js - v2

const express = require('express');
const db = require('../db');
const router = express.Router();

// Endpoint pubblico per ottenere i dettagli di un viaggio tramite EcoTrip Code
router.get('/trips/:eco_trip_code', async (req, res) => {
    try {
        const ecoTripCode = req.params.eco_trip_code; // Ottieni l'EcoTrip Code dall'URL
